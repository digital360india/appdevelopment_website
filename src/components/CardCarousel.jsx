...
const SimpleCarousel = () => {
  ...
  return (
    <div>
      <div className="w-full px-8 py-6 relative ">
        ...
        <div>
        <button className="absolute h-[45px] w-[45px] flex items-center justify-center transform border  border-[#3E3E3E] rounded-3xl translate-y-1/2" onClick={prevSlide}>
        ...
        <button className="absolute left-[100px] flex items-center justify-center h-[45px] w-[45px] transform border border-[#3E3E3E] rounded-3xl translate-y-1/2" onClick={nextSlide}>
  ...
  <button className="text-white rounded-lg bg-gradient-to-r from-[#13375D] to-[#ADBAC8] border border-white py-2 px-4  hover:bg-white  transition duration-300">Enquire Now</button>
</div>
