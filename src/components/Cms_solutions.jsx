    ...
    <div>
      <div className="cms hidden md:flex flex-col md:gap-10 xl:gap-0 sm:flex-row sm:justify-around  px-6 py-20">
        ...
        <div className="right-content flex flex-col justify-end md:gap-5 lg:gap-12 md:w-[50%]">
          ...
          <p className="font-normal  text-sm   md:text-xl lg:text-2xl md:tracking-tight w-full">
            {" "}
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
            impedit, eligendi eveniet mollitia veniam in debitis maxime autem
            neque, amet fuga excepturi blanditiis vitae velit repellendus atque?
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea unde
            suscipit aut nisi nostrum totam. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Nam, aperiam.
          </p>

          <button
            className="text-white rounded-md w-full lg:w-[341px] h-[56px]"
            style={{
