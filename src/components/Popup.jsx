    ...
    >
      <div className="bg-[#ffff] px-4  rounded-lg">
        ...
        <div className="text-center text-[#13375D]">
          <div>
            <p className="font-semibold text-[24px] pt-2 md:text-[60px]">
              Connect with our Experts
            </p>
          </div>
          <div className="pb-4">
            {" "}
            <p className="md:text-[24px] text-[8px]">
          ...
          <div className="flex flex-col gap-2 md:gap-8 lg:gap-12 xl:gap-10">
            ...
            <div className="flex justify-end md:mr-8 md:mb-4 mb-4 order-3">
              <button
                type="submit"
                name="submit"
                className="w-[100vh] md:w-[40vh] h-12 md:h-[56px] rounded-lg bg-gradient-to-r from-[#13375D] to-[#ADBAC8] text-center"
              >
                Submit
              </button>
            </div>
