                ...
                <div className="flex md:w-full flex-row mb-4">
                    {industries.map((industry, index) => (
                        <div key={index} className="md:w-1/3 flex flex-col items-center">
                            <div
                                className="relative w-[120px] h-[100px] md:w-[250px] md:h-[200px] group  mx-1 md:mx-3 hover:w-[400px] hover:h-[200px] transition-transform duration-700 transform hover:translate-x-4"
                            ...
                            >
                                <div className="cards relative rounded-md overflow-hidden transition duration-300 ease-in-out ">
                                    ...
                                    />
                                    <div className="absolute inset-0 flex justify-center items-center md:transition md:duration-300 md:ease-in-out">
                                ...
                                {hoveredIndex === index && (
                                    <div className="hover-div absolute md:inset-0 bg-[#13375D] bg-opacity-0 mr-3 rounded-md text-white md:group-hover:bg-opacity-100">
                                        <h2 className="font-Poppins text-center py-5 text-4xl">{industry.title}</h2>
